...
git add pubspec.yaml lib/main.dart README.md oruso_v03.sh
git commit -m "Upgrade ORUSO to Ver.0.3 with meal journal" || true
git push origin main

echo
echo "ORUSO Ver.0.3 update complete."
