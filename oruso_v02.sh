...
git add pubspec.yaml lib/main.dart README.md oruso_v02.sh
git commit -m "Upgrade ORUSO to Ver.0.2 with local data storage" || true
git push origin main

echo
echo "ORUSO Ver.0.2 update complete."
